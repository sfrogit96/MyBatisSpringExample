package th.project.samplecode.config;
...
@Configuration
@ComponentScan(basePackages = {"th.project.samplecode.service"})
public class AppConfig {
	 ...
	 @Bean
	    public MapperScannerConfigurer mapperScannerConfigurer() {
	        ...
	        mapperScannerConfigurer.setBasePackage("th.project.samplecode.mapper");
